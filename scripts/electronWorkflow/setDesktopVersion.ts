...
function updatePackageJson() {
  ...
  try {
    ...
    switch (releaseType) {
      case 'stable': {
        packageJson.productName = 'RelayOS';
        packageJson.name = 'lobehub-desktop';
        console.log('🌟 Setting as Stable version.');
        break;
      }
      case 'beta': {
        packageJson.productName = 'RelayOS-Beta'; // Or 'RelayOS-Beta' if preferred
      ...
      case 'nightly': {
        packageJson.productName = 'RelayOS-Nightly'; // Or 'RelayOS-Nightly'
