export default {
  ...
  'screen4.share.description':
    'Share anonymized usage data to help us improve RelayOS. This helps us understand how Agents are used and make them better.',
  ...
  'screen4.share.title': 'Help Improve RelayOS',
