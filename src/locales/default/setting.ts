export default {
  ...
  'memory.enabled.desc':
    'Allow RelayOS to extract preferences and info from conversations and use them later. You can view, edit, or clear memory anytime.',
  ...
  'settingAppearance.appTray.desc':
    'Show the RelayOS icon in the system tray or macOS menu bar. Disabling it also removes tray menu access.',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'tools.builtins.lobe-skill-store.description':
    'Browse and install agent skills from the RelayOS marketplace. Use this when you need extended capabilities or want to install a specific skill.',
