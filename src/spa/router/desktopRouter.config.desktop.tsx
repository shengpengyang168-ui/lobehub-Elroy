...
import DashboardHome from '@/routes/(main)/dashboard';
import DashboardLayout from '@/routes/(main)/dashboard/_layout';
...
export const desktopRoutes: RouteObject[] = [
  {
    children: [
      ...
      // Tasks routes (cross-agent)
      {
        ...
        errorElement: <ErrorBoundary resetPath="/home" />,
        path: 'tasks',
      },
  ...
  // Landing page route (outside main layout - no sidebar)
  {
    element: <LandingPage />,
    path: '/',
  },
