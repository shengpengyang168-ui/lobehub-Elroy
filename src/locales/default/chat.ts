export default {
  ...
  'claudeCodeInstallGuide.reason': 'RelayOS could not start Claude Code: {{message}}',
  ...
  'codexInstallGuide.reason': 'RelayOS could not start Codex: {{message}}',
  ...
  'sharePageDisclaimer':
    'This content is shared by a user and does not represent the views of RelayOS. RelayOS is not responsible for any consequences arising from this shared content.',
  ...
  'thread.threadMessageCount': '{{messageCount}} calls',
