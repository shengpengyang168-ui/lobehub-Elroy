export default {
  ...
  'protocolInstall.official.badge': 'RelayOS Official Skill',
  'protocolInstall.official.description': 'Official RelayOS Skill, verified and security-checked.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. RelayOS does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
