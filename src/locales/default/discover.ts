export default {
  ...
  'createGuide.func1.title': 'Submit in RelayOS',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the RelayOS Community.',
  'footer.title': 'Share your creation on RelayOS Community today',
